                ...
                <div className="flex flex-col sm:flex-row justify-between items-center">
                    ...
                    {!success ? (
                        <div className="py-8 sm:pt-40">
                            <div className="rounded-lg shadow-xl w-96 h-auto border">
                                <div className="px-10 sm:px-4">
                                    <h1 className="text-3xl select-none font-semibold font-roboto pt-3">
                                        Forgot Password?
                                    </h1>
                                    <p className="text-md py-3 font-sans">
                                    ...
                                    <form onSubmit={handleForgotPwd}>
                                        ...
                                        />
                                        {valid && (
                                            <div className="absolute ml-80 -mt-12 text-blue-400 text-xl pointer-events-none">
                                                <Check />
                                            </div>
                                        )}
                                        {!valid && mobile && (
                        ...
                        <div className="py-10 sm:pt-40">
                            <div className="rounded-lg shadow-xl w-96 h-auto border">
                                <div className="px-10 sm:px-4">
                                    {!newPwdSection ? (
                                        <>
                                            <h1 className="text-3xl select-none font-semibold font-roboto py-3">
                                                Forgot Password?
                                            </h1>
                                            <p className="text-md py-3 font-sans">
                                                Enter your OTP that send to your mobile
                                            </p>
                                            <p
                                                ref={errRef}
                                            ...
                                            <form id="otpForm" onSubmit={handleOTP}>
                                                <div>
                                                    ...
                                                    <button
                                                        className="w-full select-none p-3 bg-blue-500 rounded-full text-white text-xl font-roboto my-3 mb-6 font-semibold hover:bg-blue-600 disabled:hover:bg-blue-600"
                                        ...
                                        <>
                                            ...
                                            <form id="otpForm" onSubmit={newPassSubmit}>
                                                <div>
                                                    ...
                                                    <button
                                                        className="w-full select-none p-3 bg-blue-500 rounded-full text-white text-xl font-roboto mt-5 font-semibold hover:bg-blue-600 disabled:hover:bg-blue-600 mb-3"
